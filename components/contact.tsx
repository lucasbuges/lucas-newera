...
import { EMAIL, INSTAGRAM } from "@/lib/config";
      ...
      <Container className="relative">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-lg leading-relaxed text-muted">
            Me conta o que a sua empresa quer fazer com IA e onde isso travou —
            escopo, arquitetura, time ou aprovação interna. Respondo dizendo se
            consigo ajudar e em qual formato, inclusive quando a resposta é não.
          </p>
